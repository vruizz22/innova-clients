// SuperProfes Brand Icons — stroke-based, currentColor, viewBox 0 0 24 24
// SVG paths from SuperProfes-Design-System/preview/brand-icons.html
...
function icon(paths: React.ReactNode): React.FC<IconProps> {
  return function Icon({ size = 24, strokeWidth = 1.5, ...props }: IconProps): JSX.Element {
    return (
      <svg
        viewBox="0 0 24 24"
        width={size}
