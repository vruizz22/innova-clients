// Inline SVG icons (Lucide-derived). Inherits currentColor.
const Icon = ({ name, size = 20, strokeWidth = 1.5, ...rest }) => {
  const props = {
  ...
  switch (name) {
    ...
    case 'book': return <svg {...props}><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2zM22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>;
    case 'chart': return <svg {...props}><path d="M3 3v18h18"/><path d="M7 16V9M12 16V5M17 16v-4"/></svg>;
    case 'alert': return <svg {...props}><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><path d="M12 9v4"/><path d="M12 17h.01"/></svg>;
    ...
    case 'shield': return <svg {...props}><path d="M20 13c0 5-3.5 7.5-8 9-4.5-1.5-8-4-8-9V5l8-3 8 3z"/></svg>;
