...
export const mockAlerts: TeacherAlert[] = [
  {
    ...
    payload: {
      ...
      studentIds: ['seed-student-002', 'seed-student-004', 'seed-student-005'],
    },
  ...
  },
  {
    ...
    payload: {
      ...
      studentIds: ['seed-student-001', 'seed-student-002', 'seed-student-003', 'seed-student-004', 'seed-student-005'],
    },
