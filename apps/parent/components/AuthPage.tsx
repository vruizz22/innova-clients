...
export function AuthPage({ title, mode, defaultRole = 'parent' }: AuthPageProps): JSX.Element {
    ...
    <div className="auth-shell">
      ...
      <aside className="auth-aside">
        ...
        <div className="auth-pitch">
          <h2>Acompaña el aprendizaje de tu hijo/a</h2>
          <p>Monitorea el progreso matemático y recibe notificaciones cuando necesite apoyo.</p>
